<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="paymentInquiryDetailsProcess.aspx.cs" Inherits="merchantApplication.inquiryservice.paymentInquiryDetailsProcess" %>
...
<head runat="server">
    ...
    <title>Merchant Hosted Response Page </title>
					...
					<td>
						<table align="center">
							...
							<tr>
                                ...
                                <td> &nbsp;&nbsp;<b><font size="2" color="red">
                                    <asp:Label ID="transactionStatusLbl" runat="server"></asp:Label></font></b>
                                </td>
							</tr>
							<tr>
								<td>Post Date</td>
                                <td> &nbsp;&nbsp;
                                    <asp:Label ID="postDateLbl" runat="server"></asp:Label>
                                </td>
							</tr>
							<tr>
								<td>Transaction Reference ID</td>
                                <td>&nbsp;&nbsp;
                                    <asp:Label ID="transactioreferencelbl" runat="server"></asp:Label>
                                </td>
							</tr>
							<tr>
								<td>Mrch Track ID</td>
                                <td>&nbsp;&nbsp;
                                    <asp:Label ID="trackIdLbl" runat="server"></asp:Label>
                                </td>
							</tr>
							<tr>
								<td>
